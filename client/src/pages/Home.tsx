...
export default function Home() {
  ...
  const [matchData, setMatchData] = useState<{matchId: number, userId: number, matchedUserId: number} | null>(null);
  ...
  const handleMatch = (matchId: number, userId: number, matchedUserId: number) => {
  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <header className="p-4 flex items-center justify-between border-b border-neutral-200">
        ...
        <div className="logo">
          <h1 className="text-xl font-poppins font-semibold">Match<span className="text-primary">AI</span></h1>
        </div>
        <div className="filters">
          <button className="w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center">
            <i className="fas fa-sliders-h text-neutral-700"></i>
          </button>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-y-auto p-4 pb-20">
        {isLoading ? (
          ...
          <>
            ...
            >
              <p className="mb-3">
                I've noticed you often connect with people who enjoy outdoor activities. 
                I've prioritized profiles with similar interests in your discovery feed.
              </p>
              <div className="flex">
                <Button variant="link" className="text-secondary text-sm font-medium p-0">
                  Adjust Preferences
                </Button>
                <Button variant="link" className="text-neutral-500 text-sm ml-4 p-0">
                  Got it
                </Button>
              </div>
            </AiSuggestion>
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <p className="text-neutral-500 mb-4">We're working on finding your perfect match</p>
