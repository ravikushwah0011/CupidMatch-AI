    ...
    <div className="h-screen flex flex-col p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-poppins font-semibold text-neutral-900">
          Welcome to <span className="text-primary">Match<span className="text-accent">AI</span></span>
        </h1>
      ...
      <div className="flex-1 flex flex-col justify-center items-center mb-8">
        ...
        <h2 className="text-xl font-semibold text-center mb-4">I'm Cupid, your AI dating assistant</h2>
        <p className="text-center text-neutral-600 mb-6">
          I'll help you create a profile that attracts the right matches and guide you throughout your dating journey.
        </p>
        <Button 
      ...
      <div className="text-center text-sm text-neutral-500">
        <p>
          By continuing, you agree to our <a href="#" className="text-secondary">Terms</a> and <a href="#" className="text-secondary">Privacy Policy</a>
        </p>
      </div>
    </div>
  );
