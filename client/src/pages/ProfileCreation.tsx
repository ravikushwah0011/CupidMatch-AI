...
export default function ProfileCreation() {
  ...
  const [aiMessage, setAiMessage] = useState<string>("What do you enjoy doing in your free time?");
  const [options, setOptions] = useState<string[]>([
    "Reading", "Hiking", "Cooking", "Photography", "Travel", "Music", "Sports", "Art"
  ]);
  ...
  const generateProfileMutation = useMutation({
    mutationFn: async (data: Record<string, any>) => {
      return apiRequest('POST', '/api/ai/generate-profile', data);
    },
    onSuccess: (data) => {
  ...
  const getInputKey = (stepNum: number): string => {
    switch(stepNum) {
      ...
      case 3: return "nameAge";
      case 4: return "location";
      case 5: return "occupation";
      case 6: return "education";
      case 7: return "partnerQualities";
  ...
  const updateOptionsForQuestion = (stepNum: number) => {
    switch(stepNum) {
      case 1: // Interests
        setOptions(["Reading", "Hiking", "Cooking", "Photography", "Travel", "Music", "Sports", "Art"]);
        break;
      ...
      case 3: // Name and age
        ...
        break;
      case 4: // Location
        setOptions(["New York", "Los Angeles", "Chicago", "San Francisco", "Miami", "Austin", "Seattle"]);
        break;
      case 5: // Occupation
        setOptions(["Software Engineer", "Designer", "Teacher", "Healthcare", "Marketing", "Student", "Entrepreneur"]);
        break;
      case 6: // Education
        setOptions(["High School", "Associate's Degree", "Bachelor's Degree", "Master's Degree", "PhD"]);
        break;
      case 7: // Partner qualities
        setOptions(["Kind", "Ambitious", "Funny", "Adventurous", "Intelligent", "Creative", "Reliable"]);
        break;
      default:
        setOptions([]);
    }
  ...
  const userInputsToProfileData = (): Record<string, any> => {
    ...
    userInputs.forEach(input => {
      ...
      } else if (input.key === "interests" || input.key === "partnerQualities") {
  ...
  const handleSkip = () => {
    ...
    localStorage.setItem('generatedProfile', JSON.stringify({
  ...
  return (
    <div className="h-screen flex flex-col p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="text-neutral-600" onClick={handleSkip}>Skip</button>
      </div>
      
      <div className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Tell me about yourself</h2>
        <p className="text-neutral-600">I'll help create an engaging profile based on your responses.</p>
      </div>
